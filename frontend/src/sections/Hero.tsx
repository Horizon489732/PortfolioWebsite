          ...
          <div className="md:col-span-7 flex flex-col justify-center">
                <div className="container !max-w-full">
                  ...
                  className="text-5xl md:text-6xl mt-40 md:mt-0">
                    From Equations to Applications — Building Systems That Work
                  </motion.h1>

                  <div className="flex flex-col md:flex-row md:items-center mt-10 items-start gap-6">
                    <motion.div initial={{opacity: 0, y: "100%"}} animate={{opacity: 1, y: 0}} transition={{duration: 0.7, delay: 1.75}}>
                      <Button variant="secondary" iconAfter={
                        <div className="overflow-x-hidden size-5">

                          <div className="h-5 w-10 flex group-hover/button:-translate-x-1/2 transition-all duration-500">
