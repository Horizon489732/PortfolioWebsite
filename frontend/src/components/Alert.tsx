...
const Alert = ({ type, message, onClose, className, ...other }: AlertProps) => {
    return(
        <div className={twMerge("fixed text-neutral-light z-50 top-[80px] right-[-500px] animate-slide-in-out flex w-full rounded-lg flex-col max-w-[400px] transform items-start justify-start gap-4 transition delay-200 duration-500 ease-in-out",
                        className)} {...other} >
            <div className="flex w-full items-center justify-between p-3 rounded-sm"
